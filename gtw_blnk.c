...
void win_blank_redraw(window_t *win)
{
    ...
    gli_curses_mvaddch_uni(win->bbox.top, win->bbox.left, '/');
    gli_curses_mvaddch_uni(win->bbox.top, win->bbox.right-1, '\\');
    gli_curses_mvaddch_uni(win->bbox.bottom-1, win->bbox.left, '\\');
    gli_curses_mvaddch_uni(win->bbox.bottom-1, win->bbox.right-1, '/');
}
